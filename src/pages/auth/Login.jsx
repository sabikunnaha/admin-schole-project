                    ...
                    <form onSubmit={handleLogin}>
                        ...
                        <div className="mb-4">
                            <input
                                ...
                                onBlur={() => setFocused("")}
                                className="w-full px-4 py-2 h-[42px] outline-none text-gray-700 text-sm"
                                style={{
                        ...
                        <div className="mb-5 relative">
                            <input
                                ...
                                onBlur={() => setFocused("")}
                                className="w-full px-4 py-2 h-[42px]  outline-none text-gray-700 text-sm pr-10"
                                style={{
                            ...
                            <button
                                ...
                                className="absolute h-[42px] right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-blue-500"
                        ...
                        <div className="flex gap-3 mb-4">
                            <button
                                type="button"
                                className="flex-1 h-[42px] py-2 font-semibold text-white text-sm"
                                style={{
                                    background: "#2563eb",
                            ...
                            <button
                                type="submit"
                                className="flex-1 py-2 h-[42px] font-semibold text-white text-sm flex items-center justify-center gap-2"
                                style={{
                        ...
                        <div className="mb-5">
                            <div className="flex items-center justify-center gap-1 py-2 text-sm "
                                ...
                                <span className="text-gray-500" style={{ fontFamily: "'Segoe UI', sans-serif" }}>
                        ...
                        <div className="flex justify-center gap-4">
                            ...
                            <button type="button"
                                ...
                                style={{ width: 42, height: 42, background: "#1877f2", border: "none", cursor: "pointer", boxShadow: "0 2px 8px rgba(24,119,242,0.3)" }}>
                            ...
                            <button type="button"
                                className="flex items-center justify-center rounded-full text-white transition-transform hover:scale-110 active:scale-95"
                                style={{ width: 42, height: 42, background: "#25d366", border: "none", cursor: "pointer", boxShadow: "0 2px 8px rgba(37,211,102,0.3)" }}>
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
